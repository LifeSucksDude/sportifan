...
class _CreateTeamState extends State<CreateTeam> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        return await showLogoutDialog(context, createTeam);
      },
      child: SafeArea(
        child: Scaffold(
          body: SafeArea(
                      ...
                      children: [
                        Container(
                          ...
                          child: GestureDetector(
                            ...
                            onTap: () async {
                              if (await showLogoutDialog(context, createTeam)) {
...
Future<bool> showLogoutDialog(BuildContext context, Function createTeam) {
